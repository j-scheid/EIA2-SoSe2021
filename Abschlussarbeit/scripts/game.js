...
(function (Final) {
    var Game = /** @class */ (function () {
        ...
        Game.prototype.resetBall = function (_team) {
            if (this.ballPosession === undefined)
                return;
            if (!_team) {
                _team = this.ballPosession < 0 ? 1 : 2;
            }
            var players = this.getPlayers().filter(function (player) { return player.team !== _team; });
        ...
        Game.prototype.update = function () {
            ...
            if (this.state === Final.GameState.RUNNING) {
                ...
                this.movables.forEach(function (e) { return e.update(_this); });
            }
        };
        Game.prototype.render = function (_ctx) {
            var _this = this;
            this.field.render(_ctx, this);
            this.movables.forEach(function (e) { return e.render(_ctx, _this); });
            this.ball.render(_ctx, this);
            if (this.state === Final.GameState.SHOOTING) {
                _ctx.strokeStyle = "red";
                _ctx.beginPath();
                _ctx.lineWidth = 3;
                _ctx.arc(Final.mouse.x, Final.mouse.y, this.ball.radius, 0, 2 * Math.PI, false);
                _ctx.stroke();
            }
        ...
        Game.prototype.getPlayers = function () {
            return this.movables.filter(function (e) { return e instanceof Final.Player; });
        };
        ...
        Game.prototype.initSoccer = function () {
            ...
            // REFEREE
            var referee = new Final.Referee(new Final.Vector(this.field.width / 2 - 10, this.field.height / 2 - 10));
            ...
            this.movables.forEach(function (e) { return e.init(_this); });
        };
        ...
        Game.prototype.initGUI = function () {
            ...
            removeBtn.addEventListener("click", function (e) {
                ...
                if (!selectedPlayer)
                    return;
                var idx = _this.movables.indexOf(selectedPlayer);
                _this.movables.splice(idx, 1);
            });
            // PLAYER ADDING
            ...
            addBtn.addEventListener("click", function (e) {
                ...
                var addPlayer = function () {
                    ...
                    var playerNumber;
                    while (true) {
                        playerNumber = Math.floor(Final.randomBetween(0, _this.movables.length + 1));
